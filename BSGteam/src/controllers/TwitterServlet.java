		...
		try {
			...
			for (Status tweet1 : tweets) {
				...
				response.getWriter().println(
						"<tr><td><img src='"
								+ tweet1.getUser().getOriginalProfileImageURL()
								+ "' height='100' width='100'>"
								+ "<td><a href='timelines?screenname="+ tweet1.getUser().getScreenName() + "'>'"
								+ tweet1.getUser().getScreenName() + "</a></td><td>"
								+ tweet1.getUser().getLocation() + "<td>"
								+ tweet1.getUser().getDescription() + "<td>"
								+ tweet1.getText() + "<td>"
								+ tweet1.getRetweetCount() + "</td></tr>");
			}
