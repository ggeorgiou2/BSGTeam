...
public class FrequentWord {
	...
	/**
	 * @param tweets group of  tweets to be analyze
	...
	public List<Map.Entry<String, Integer>> countWord(String tweets ) {
		...
		//declared wordCounts as variable of type TreeMap
		...
		//declared uniqeWors as variable of type HashSet and assigns the splits result to it.
	...
	/**
	 * @param map an argument of type Map<String, Integer>
	 * @return sorts List in descending order
	 */
