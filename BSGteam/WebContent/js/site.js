...
$(function() {
	...
	function getPlace() {
		...
		$.ajax({
	  		type: "GET",
	  		 url: "https://api.foursquare.com/v2/venues/explore?ll="+formLat+","+formLng+"&client_id=KTSRNGJZY4BGFSZAQYGKP2BBTZGGJAMXWKQSYTOSTV5WC31H&client_secret=4KYFXNFEMT5RAIO3DEXMBC52ALUQG3AIXJHGBDBNYISGTO1H&v=20130619&query="+$("#query").val()+"",
	  		success: function(data) {
				...
				$.each( dataobj, function() {
					...
					bond = '<div class="venue"><h2><span>'+this.venue.name+" "+rating+'</span></h2>'+address+phone+'</p><p><strong>Total Checkins:</strong> '+this.venue.stats.checkinsCount+'</p></div>';
					$("#venues").append(bond);
