				...
				<form class="form-horizontal"  action="#map-canvas">
					<fieldset>
						...
						<div class="form-group">
      					<h3>Dispay GeoTag Picture within a location</h3>
      					</div>
      					
      					<div class="form-group">
      					<label for="key" class="col-lg-2 control-label">Flickr Api Key:</label>
      					<div class="col-lg-10">
      					<input id="key" class="form-control" value="708b152e66c81284392c00ab2d037c1a" placeholder="708b152e66c81284392c00ab2d037c1a" required>
      					</div>
      					</div>
      					
      					<div class="form-group">
      					<label for="lat" class="col-lg-2 control-label">Lat:</label>
     					<div class="col-lg-10">
     					 <input id="lat"  class="form-control" value="38.8951" placeholder="38.8951" required>
     					 </div>
     					</div>
     					 
     					 <div class="form-group">
      					<label for="lon" class="col-lg-2 control-label">Lon:</label>
      					<div class="col-lg-10">
      					<input id="lon" class="form-control" value="-77.0367" placeholder="-77.0367" required>
      					</div>
      					</div>
      					...
      					<div class="col-lg-10">
      					<input id="tag"  class="form-control" value="money" placeholder="money" required>
      					</div>
      					</div>
...
<div>
    ...
    <script type="text/javascript"
      src="https://maps.googleapis.com/maps/api/js?sensor=false&key=AIzaSyB3WDbJuoc6iqUEQ7ZkiQWHw6eqO5Os8Zc">
			...
			function getFlickrPhotos(map, flickrApi, searchLat, searchLon, hashkey) {
			  ...
			  function getAndMarkPhotos(photos) {
			    ...
			    for(var i=0; i<numPhotos; i++) {
			      ...
			      getPhotoLocation(photo.id,photo.secret,photo.farm,photo.server,photo.title);
			    }
			  }
			    ...
			    $.ajax({
			      ...
			      success: function(data) {
			        ...
			        var photoLon = $(location).attr('longitude');
			         addOverlay(photoLat, photoLon, photoId, secret,farm,server,title,map);
			  ...
			  function addOverlay(lat, lon, text,secret,farm,server,title, map) {
			    ...
			    infowindow = new google.maps.InfoWindow({
			       // content: "<div><img width='254' height='355' src='http://www.hyperpac.de/wp-content/uploads/2009/09/255px-Excitebike_cover.jpg'</div>"
			    	...
			    	content: "<div><h3>" + title + "</h3><img width='254' height='355' src='http://farm" + farm  + ".static.flickr.com/" + server+ "/" + text + "_"+ secret + "_m.jpg'</div>" 	
			    });
		...
		<script>
			$(document).ready(function() {
				  ...
				  $('#search').on('click', function() {
				    ...
				    getFlickrPhotos(googleMap,flickrApiKey, searchLat, searchLon,hashKey);
				  });
		...
		<div class="search" id="map-canvas">
